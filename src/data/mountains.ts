...
export const MOUNTAINS: Mountain[] = [
  // Colorado
  { name: "Vail", state: "CO", lat: 39.6061, lng: -106.3550, bbox: [39.58, -106.41, 39.64, -106.31], slug: "vail", peakSlope: 35.4 },
  { name: "Breckenridge", state: "CO", lat: 39.4808, lng: -106.0676, bbox: [39.45, -106.11, 39.51, -106.03], slug: "breckenridge", peakSlope: 38.8 },
  ...
  { name: "Steamboat", state: "CO", lat: 40.4572, lng: -106.8045, bbox: [40.44, -106.83, 40.48, -106.78], slug: "steamboat-ski-resort", peakSlope: 37.3 },
  { name: "Winter Park", state: "CO", lat: 39.8914, lng: -105.7625, bbox: [39.87, -105.80, 39.91, -105.73], slug: "winter-park", peakSlope: 18.8 },
  { name: "Beaver Creek", state: "CO", lat: 39.6042, lng: -106.5164, bbox: [39.58, -106.55, 39.63, -106.49], slug: "beaver-creek", peakSlope: 33.0 },
  ...
  { name: "Snowbird", state: "UT", lat: 40.5830, lng: -111.6556, bbox: [40.57, -111.67, 40.60, -111.64], slug: "snowbird", peakSlope: 48.0 },
  { name: "Alta", state: "UT", lat: 40.5884, lng: -111.6386, bbox: [40.57, -111.66, 40.60, -111.62], slug: "alta-ski-area", peakSlope: 41.1 },
  ...
  // California
  { name: "Palisades Tahoe", state: "CA", lat: 39.1968, lng: -120.2354, bbox: [39.18, -120.26, 39.21, -120.22], slug: "palisades-tahoe", peakSlope: 41.9 },
  ...
  // Montana
  { name: "Big Sky", state: "MT", lat: 45.2836, lng: -111.4014, bbox: [45.26, -111.44, 45.31, -111.36], slug: "big-sky-resort", peakSlope: 46.3 },
  { name: "Whitefish Mountain", state: "MT", lat: 48.4849, lng: -114.3539, bbox: [48.47, -114.38, 48.50, -114.33], slug: "whitefish-mountain-resort", peakSlope: 44.1 },
  // Wyoming
  { name: "Jackson Hole", state: "WY", lat: 43.5877, lng: -110.8279, bbox: [43.57, -110.86, 43.61, -110.80], slug: "jackson-hole-mountain-resort", peakSlope: 46.3 },
  // Idaho
  { name: "Sun Valley", state: "ID", lat: 43.6975, lng: -114.3514, bbox: [43.68, -114.37, 43.72, -114.33], slug: "sun-valley", peakSlope: 36.7 },
  // New Mexico
  ...
  // Vermont
  { name: "Stowe", state: "VT", lat: 44.5303, lng: -72.7814, bbox: [44.51, -72.81, 44.55, -72.75], slug: "stowe-mountain-resort", peakSlope: 37.7 },
  { name: "Killington", state: "VT", lat: 43.6197, lng: -72.7972, bbox: [43.60, -72.83, 43.64, -72.77], slug: "killington-resort", peakSlope: 38.7 },
  { name: "Sugarbush", state: "VT", lat: 44.1358, lng: -72.9033, bbox: [44.12, -72.93, 44.15, -72.88], slug: "sugarbush-resort", peakSlope: 32.2 },
  { name: "Jay Peak", state: "VT", lat: 44.9268, lng: -72.5098, bbox: [44.91, -72.53, 44.94, -72.49], slug: "jay-peak-resort", peakSlope: 29.2 },
  { name: "Mad River Glen", state: "VT", lat: 44.2036, lng: -72.9186, bbox: [44.19, -72.93, 44.22, -72.90], slug: "mad-river-glen", peakSlope: 34.7 },
  // New Hampshire
  ...
  // Maine
  { name: "Sugarloaf", state: "ME", lat: 45.0314, lng: -70.3131, bbox: [45.02, -70.34, 45.05, -70.29], slug: "sugarloaf", peakSlope: 32.9 },
  { name: "Sunday River", state: "ME", lat: 44.4728, lng: -70.8564, bbox: [44.45, -70.88, 44.49, -70.83], slug: "sunday-river", peakSlope: 27.9 },
  // New York
  { name: "Whiteface", state: "NY", lat: 44.3661, lng: -73.9028, bbox: [44.35, -73.93, 44.38, -73.88], slug: "whiteface-mountain", peakSlope: 30.5 },
  { name: "Gore Mountain", state: "NY", lat: 43.6731, lng: -74.0064, bbox: [43.66, -74.03, 43.69, -73.98], slug: "gore-mountain", peakSlope: 33.0 },
  { name: "Hunter Mountain", state: "NY", lat: 42.2014, lng: -74.2264, bbox: [42.19, -74.24, 42.22, -74.21], slug: "hunter-mountain", peakSlope: 30.5 },
  // Washington
  { name: "Crystal Mountain", state: "WA", lat: 46.9350, lng: -121.5044, bbox: [46.92, -121.53, 46.95, -121.48], slug: "crystal-mountain", peakSlope: 42.5 },
  ...
  // Oregon
  { name: "Mt. Bachelor", state: "OR", lat: 43.9792, lng: -121.6886, bbox: [43.96, -121.72, 44.00, -121.66], slug: "mt-bachelor", peakSlope: 30.9 },
  ...
  // Michigan
  { name: "Boyne Mountain", state: "MI", lat: 45.1642, lng: -84.9361, bbox: [45.15, -84.95, 45.18, -84.92], slug: "boyne-mountain-resort", peakSlope: 25.9 },
  // West Virginia
  { name: "Snowshoe", state: "WV", lat: 38.4089, lng: -79.9939, bbox: [38.39, -80.01, 38.43, -79.97], slug: "snowshoe-mountain", peakSlope: 26.0 },
  // Canada
  { name: "Whistler Blackcomb", state: "BC", lat: 50.1163, lng: -122.9574, bbox: [50.06, -123.00, 50.16, -122.90], slug: "whistler-blackcomb", peakSlope: 52.5 },
  { name: "Mont Tremblant", state: "QC", lat: 46.2097, lng: -74.5856, bbox: [46.19, -74.61, 46.23, -74.56], slug: "mont-tremblant-resort", peakSlope: 32.5 },
];
